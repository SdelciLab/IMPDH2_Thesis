...
*plot γH2AX*
```{r}
filtered_data$Identifier <- factor(filtered_data$Identifier, 
...
pdf("/Users/alisc/Desktop/CRG/final_figures/ATM_ATR/yH2AX_new.pdf")
ggplot(filtered_data2, aes(x = Identifier, y =full.nuclei...Number.of.Spots , fill = Treatment)) + 
 geom_boxplot(width = 0.75, fatten = 2)  +   stat_compare_means(comparisons = my_comparisons, method = "wilcox", label = "p.signif") +
...
ggplot(filtered_data2, aes(x = Drug, y =full.nuclei...Number.of.Spots , fill = Treatment)) +
 geom_boxplot(width = 0.75, fatten = 2) + 
    labs(x = "", y = "yH2AX foci per nucleus") +theme_classic() +  scale_fill_brewer(palette="Accent") + stat_compare_means(method = "wilcox", aes(group = Treatment), label = "p.signif")  
dev.off()
```
*plot IMPDH2*
```{r}
...
pdf("/Users/alisc/Desktop/CRG/final_figures/ATM_ATR/IMPDH2_new.pdf")
ggplot(filtered_data2, aes(x = Identifier, y = full.nuclei...Intensity.Nucleus.Alexa.488.Mean, fill= Treatment)) +  
 geom_boxplot(width = 0.75, fatten = 2) + 
  ...
  theme_classic() +  scale_fill_brewer(palette="Accent")+  theme(legend.position = "none") +   stat_compare_means(comparisons = my_comparisons, method = "wilcox", label = "p.signif")

ggplot(filtered_data2, aes(x = Drug, y = full.nuclei...Intensity.Nucleus.Alexa.488.Mean, fill= Treatment)) +  
 geom_boxplot(width = 0.75, fatten = 2) + 
  labs(x = "", y = "IMPDH2 intensity nucleus")  +stat_compare_means(method = "wilcox", aes(group = Treatment), label = "p.signif") +
  theme_classic()+  scale_fill_brewer(palette="Accent")
dev.off()
```
*plot γH2AX nomalised by DMSO*
```{r}
...
pdf("/Users/alisc/Desktop/CRG/final_figures/ATM_ATR/yH2AX_DMSO_norm.pdf")
ggplot(df_normalized, aes(x = Drug, y =Normalized_Value , fill = Treatment)) +
 geom_boxplot(width = 0.75, fatten = 2) + 
    labs(x = "", y = "yH2AX foci normalised by DMSO") +theme_classic() +  scale_fill_brewer(palette="Accent") + stat_compare_means(method = "wilcox", aes(group = Treatment), label = "p.signif")  
dev.off()
```
*plot IMPDH2 nomalised by DMSO*
```{r}
filtered_data2 <- filtered_data2 %>%
  group_by(Drug, Treatment) %>%
...
pdf("/Users/alisc/Desktop/CRG/final_figures/ATM_ATR/IMPDH2DMSO_norm.pdf")
ggplot(df_normalized, aes(x = Drug, y =Normalized_Value , fill = Treatment)) +
 geom_boxplot(width = 0.75, fatten = 2) + 
    labs(x = "", y = "IMPDH2 intensity normalised by DMSO") +theme_classic() +  scale_fill_brewer(palette="Accent") + stat_compare_means(method = "wilcox", aes(group = Treatment), label = "p.signif")  
dev.off()
```
