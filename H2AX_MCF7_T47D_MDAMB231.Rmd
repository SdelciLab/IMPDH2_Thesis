...
data_WT_cells_int_cond$Cell <- factor(data_WT_cells_int_cond$Cell, levels = c("MCF7", "T47D",
                                                                              "MDAMB231"))
table(data_WT_cells_int_cond$Cell)
```
*Sampling*
to represent balanced data as dots
...
pdf("/Users/alisc/Desktop/CRG/final_figures/H2AX_MCF7_T47D_MDAMB231/balanced_jitter_old_colors.pdf")
